...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self,train_x,train_y):
        """
                        ...
                        """
        self.file_object=open('logger.txt','a')
        self.logger.log(self.file_object, 'Entered the get_best_params_for_random_forest method of the Model_Finder class')
        try:
    ...
    def get_best_model(self,train_x,train_y,test_x,test_y):
        ...
        try:
            ...
            self.logger.log(self.file_object, 'Accuracy for knn:' + str(self.knn_score))  # Log AUC
            ...
            self.logger.log(self.file_object, 'Accuracy for RF:' + str(self.random_forest_score))
            
            #comparing the two models
            if(self.random_forest_score <  self.knn_score):
                return 'KNN',self.knn
                self.logger.log(self.file_object, 'best model is knn')
            else:
                return 'RandomForest',self.random_forest
                self.logger.log(self.file_object, 'best model is RandomForest')
